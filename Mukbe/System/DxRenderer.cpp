...
HRESULT DxRenderer::CreateDevice()
{
	...
	//Direct2d와 Direct3d의 상호운영을 가능하게 함
...
HRESULT DxRenderer::CreateSwapChain(void)
{
	...
	sd.BufferDesc.Width = (UINT)d3dDesc.Width;				//	후면 버퍼 너비
	sd.BufferDesc.Height = (UINT)d3dDesc.Height;				//	후면 버퍼 높이
...
void DxRenderer::OnResize()
{
	...
	depthStencilDesc.Width = (UINT)d3dDesc.Width;		//	너비
	depthStencilDesc.Height = (UINT)d3dDesc.Height;	//	높이
